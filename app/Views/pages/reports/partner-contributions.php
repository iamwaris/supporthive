...
<div class="flex flex-col gap-5">
    <form method="get" action="<?= e(url('/reports/partner-contributions')) ?>" class="card flex flex-wrap items-end gap-3 px-5 py-4">
        <div>
        ...
        <a href="<?= e(url('/reports/partner-contributions') . '?' . http_build_query(['from' => $from, 'to' => $to, 'format' => 'csv'])) ?>"
           class="btn-secondary ml-auto">Export CSV</a>
        <a href="<?= e(url('/reports/partner-contributions') . '?' . http_build_query(['from' => $from, 'to' => $to, 'format' => 'pdf'])) ?>"
    ...
    <div class="card overflow-hidden">
        ...
        <table class="w-full border-collapse">
            ...
            <tbody>
                <?php if ($rows === []) : ?>
                    <tr><td class="td py-8 text-center text-sm text-slate-500" colspan="3">No contributions in this period.</td></tr>
                <?php endif; ?>
