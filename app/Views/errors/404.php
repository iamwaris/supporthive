...
<body class="grid h-full place-items-center bg-slate-50 p-6 text-slate-900">
    <div class="max-w-md text-center">
        ...
        <h1 class="mt-2 text-2xl font-semibold tracking-tight">We couldn't find that page</h1>
        <p class="mt-3 text-slate-600">
            <?= $safeMessage !== '' ? e($safeMessage) : 'The link may be broken or the page may have moved.' ?>
        </p>
