...
<body class="grid h-full place-items-center bg-slate-50 p-6 text-slate-900">
    <div class="max-w-md text-center">
        <p class="text-sm font-semibold uppercase tracking-widest text-indigo-600">429</p>
        <h1 class="mt-2 text-2xl font-semibold tracking-tight">Too many attempts</h1>
        <p class="mt-3 text-slate-600">
            <?= $safeMessage !== '' ? e($safeMessage) : 'Please wait a moment before trying again.' ?>
        </p>
